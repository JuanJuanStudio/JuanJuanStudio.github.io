[index.html](https://github.com/user-attachments/files/28695620/index.html)
<!DOCTYPE html>
...
<script type="text/javascript">
    (function (window) {
        function setup(TSC) {
             TSC.playerConfiguration.addMediaSrc("小飞机.mp4");
             TSC.playerConfiguration.setXMPSrc("小飞机_config.xml");
             ...
             TSC.playerConfiguration.setPosterImageSrc("小飞机_First_Frame.png");
